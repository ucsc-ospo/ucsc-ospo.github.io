...
These pet projects were fun and eductational.
I am excited for the opportunity to further improve my skills and assist the open source community.
Through Google Summer of Code via UCSC OSPO, I will be contributing to the [LMS-Toolkit](/project/osre26/ucsc/lms-toolkit) project this summer!
...
Listing course users properly required parsing HTML and extracting the users, removing unnecessary data to reduce test data file sizes, and standardizing random data in the stored responses.
