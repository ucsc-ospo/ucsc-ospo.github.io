...
- Option B (via git):
  ...
  - In `index.md` fill in the frontmatter (between `---`s, see [example](https://raw.githubusercontent.com/carlosmalt/ucsc-ospo/main/content/project/osre22/ucsc/polyphorm/index.md)):
...
- Option A: email OSRE [administrators](mailto:slieggi@ucsc.edu) (currently: Stephanie Lieggi, Carlos Maltzahn)
  - Include name, title, affiliations, email, short bio, and, optionally, photo, web page and social media links
- Option B (via git): 
